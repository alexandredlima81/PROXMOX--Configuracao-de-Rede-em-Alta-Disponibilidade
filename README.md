...
<div style="display: flex; align-items: flex-start;">
  <img src="images/icons8-proxmox-240.png" alt="Descrição da imagem" style="width: 100px; margin-right: 20px;">
  <div>
  
  </div>
</div>

# <img src="images/icons8-proxmox-240.png" alt="LOGO" width="50"> Configuração de Rede em Alta Disponibilidade para ambientes de virtualização Proxmox
