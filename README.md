...
<img src="images/icons8-proxmox-240.png" alt="LOGO" width="50" style="vertical-align: -13px;">  # Configuração de Rede em Alta Disponibilidade para ambientes de virtualização PROXMOX
